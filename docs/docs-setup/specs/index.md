...
- [OKF validator behaviour and invocation](/docs-setup/specs/validator.md) - the strict 0/1/2 exit contract, the YAML frontmatter oracle, the warning suite, the uniform no-exclusion walk, enforcement wiring (CI, pre-push recipes, optional PR workflow), the raw-byte mirror test, and how to run the validator and its tests
